...
const Footer = (props) => {
    console.log(props.c_footerdeepblue.c_site)
  return (
    <>
    ...
    <div className="container-custom mx-auto flex flex-wrap items-center">
        <div className="w-full lg:w-[40%] px-4">
            ...
            {props.c_footerdeepblue.c_footeritem.map((c_footer,i)=>{
            
                    return(<>
                        <li className="mx-3 py-1"><a href={c_footer.link} className="" >{c_footer.title}</a></li>
                        </>)
        ...
        <div className="w-full lg:w-[20%] my-2 lg:my-0">
            <ul className="flex items-center justify-center">
                        ...
                        <svg className="w-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="insta"
        ...
        <div className="w-full lg:w-[40%] px-4 mb-auto text-center uppercase lg:text-right">
                <small>{props.c_footerdeepblue.c_site}</small>
        </div>

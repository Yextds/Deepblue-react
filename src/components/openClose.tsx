  ...
  let hoursString = 'Closed';
        if (openRightNow) {
          ...
          if (nextIsTomorrow) {
            ...
            hoursString = 'Closed - Opens at [openingTime] demain';
    ...
    <>
      <div className="flex  flex-wrap text-2xl md:text-4xl pt-[36px] pb-[36px] lg:pt-[71px] lg:pb-[55px] items-center px-5 text-center lg:px-10 md:px-auto justify-around md:justify-around text-[#024B58]">
            {props.hours.reopenDate?
                <h3 className="font-evogriaregular text-2xl md:text-[28px]">Temporarily Closed</h3>:props.hours?
                ...
                <h3 className="font-evogriaregular text-2xl md:text-[28px]">Closed</h3>
            }
         </div>
    </>
  )
